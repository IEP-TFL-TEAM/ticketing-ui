			...
			<div class={divideStyles}>
				...
				<div class="flex flex-col gap-2 pt-4">
					...
					<div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-6">
						...
						<span class={spanStyles}>{routine.involvedSystem}</span>
					</div>
					...
					<div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-6">
						...
						<span class={spanStyles}>{extractMessage(routine.summary)}</span>
					</div>
					...
					<div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-6">
						...
						<span class={spanStyles}>{extractMessage(routine.risksAndMitigations)}</span>
					</div>

					<div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-6">
						<span> Roll Back Procedures: </span>
						<span class={spanStyles}>{extractMessage(routine.rollbackProcedures)}</span>
					</div>
